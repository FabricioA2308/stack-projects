...
export default function Checkout() {
  ...
  function handleSubmit(event) {
    ...
    const customerData = Object.fromEntries(fd.entries()); // key value pairs to a normal object from the form data
  ...
  return (
    <Modal open={userProgressCtx.progress === "checkout"} onClose={handleClose}>
      <form onSubmit={handleSubmit}>
        <h2>Checkout</h2>
        <p>Total Amount: {currencyFormater.format(cartTotalPrice)}</p>
